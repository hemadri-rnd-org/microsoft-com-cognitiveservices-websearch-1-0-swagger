# microsoft.com API - Version cognitiveservices-WebSearch
...
- **Version**: cognitiveservices-WebSearch
- **File**: swagger.yaml
- **Original Path**: microsoft.com/cognitiveservices-WebSearch/1.0/swagger.yaml
